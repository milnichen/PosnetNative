...
// Prefer the standard header for fixed-width integer types. On MSVC and
// modern toolchains <stdint.h> is available; avoid redefining the
// standard types which can cause redefinition errors when windows
// headers or the C runtime already provide them.
#include <stdint.h>
