...
// This header is used by 1C Native API templates to provide COM-like types on Linux.
// On Windows it is intentionally empty because <windows.h> provides required types.
